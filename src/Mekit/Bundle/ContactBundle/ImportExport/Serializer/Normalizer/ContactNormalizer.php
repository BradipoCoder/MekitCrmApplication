<?php
namespace Mekit\Bundle\ContactBundle\ImportExport\Serializer\Normalizer;
...
use Mekit\Bundle\ContactBundle\Formatter\SocialUrlFormatter;
use Mekit\Bundle\ContactBundle\Model\Social;

class ContactNormalizer extends ConfigurableEntityNormalizer
{
    const CONTACT_TYPE = 'Mekit\Bundle\ContactBundle\Entity\Contact';
