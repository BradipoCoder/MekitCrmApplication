...
class CallCalendarNormalizer
{
	 ...
	 * @return array
	 */
	public function getCalls($calendarId, AbstractQuery $query)
	{
		$result = [];
		...
		$this->reminderManager->applyReminders($result, 'Mekit\Bundle\CallBundle\Entity\Call');
		return $result;
	}
}